...
#define XTSegmentControlLineHeight (1.5)
...
{
    if (isSelected) {
        self.titleLabel.textColor = LWColor(242, 155, 26);
    }else
...
- (id)initWithFrame:(CGRect)frame Items:(NSArray *)titleItem
{
    if (self = [super initWithFrame:frame]) {
        ...
        _contentView = ({
            ...
            scrollView.backgroundColor = [UIColor colorWithRed:246.0/255 green:246.0/255 blue:249.0/255 alpha:1.0f];
...
//        _rightShadowView = [[UIImageView alloc] initWithFrame:CGRectMake(282, 0, 38, CGRectGetHeight(self.bounds)-2)];
...
- (void)addRedLine
{
    if (!_lineView) {
        ...
        _lineView.backgroundColor = [UIColor colorWithRed:244.0f/255.0f green:155.0f/255.0f blue:26.0f/255.0f alpha:1.0];
